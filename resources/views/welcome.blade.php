                    ...
                    <div class="backdrop-blur-xl bg-white/40 dark:bg-black/20 rounded-2xl overflow-hidden border border-white/30 dark:border-white/10 shadow-lg card-hover">
                        ...
                        <div class="p-2.5 sm:p-3">
                            ...
                            <div class="flex items-center gap-0.5 sm:gap-1">
                                ...
                                <span class="font-bold text-xs sm:text-sm text-gray-900 dark:text-white">4.8</span>
                                <span class="text-[10px] sm:text-xs text-gray-500 dark:text-gray-400">(120)</span>
                            </div>
                        </div>
                    </div>
                </a>
