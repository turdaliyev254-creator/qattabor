        ...
        <div class="overflow-x-auto scrollbar-hide -mx-4 px-4">
            <div class="flex gap-3">
                ...
                <a href="#" class="flex-shrink-0 w-56 group">
                    <div class="bg-white dark:bg-gray-800 rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-all border border-gray-100 dark:border-gray-700">
                        <!-- Image -->
                        ...
                        <!-- Content -->
                        <div class="p-3">
                            <h3 class="font-semibold text-base text-gray-900 dark:text-white mb-1.5 line-clamp-1">{{ $place->name }}</h3>
                            <div class="flex items-center gap-1.5 text-xs text-gray-600 dark:text-gray-400 mb-1.5">
                            ...
                            <div class="flex items-center gap-0.5">
                                ...
                                <span class="font-semibold text-sm text-gray-900 dark:text-white">4.8</span>
                ...
                <a href="#" class="flex-shrink-0 w-56 group">
                    <div class="bg-white dark:bg-gray-800 rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-all border border-gray-100 dark:border-gray-700">
                        <!-- Image -->
                        <div class="relative h-36 overflow-hidden">
                            <img src="https://images.unsplash.com/photo-{{ 1600596542815 + ($i * 1000) }}-ffad4c1539a9?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" 
                                 alt="Place {{ $i }}" 
                                 class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-300">
                            <div class="absolute top-2 right-2">
                                <button class="p-1.5 bg-white/90 backdrop-blur-sm rounded-full hover:bg-white transition-colors">
                        ...
                        <!-- Content -->
                        <div class="p-3">
                            <h3 class="font-semibold text-base text-gray-900 dark:text-white mb-1.5 line-clamp-1">Mashhur Joy {{ $i }}</h3>
                            <div class="flex items-center gap-1.5 text-xs text-gray-600 dark:text-gray-400 mb-1.5">
                                <svg class="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M5.05 4.05a7 7 0 119.9 9.9L10 18.9l-4.95-4.95a7 7 0 010-9.9zM10 11a2 2 0 100-4 2 2 0 000 4z" clip-rule="evenodd"/>
                                </svg>
                            ...
                            <div class="flex items-center gap-0.5">
                                ...
                                <span class="font-semibold text-sm text-gray-900 dark:text-white">4.{{ 5 + $i }}</span>
                                <span class="text-xs text-gray-500 dark:text-gray-400">({{ 50 + ($i * 20) }})</span>
                            </div>
                        </div>
                    </div>
                </a>
