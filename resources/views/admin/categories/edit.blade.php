            ...
            <div class="space-y-6">
                ...
                <div id="fields-uz" class="lang-fields">
                    <div>
                        ...
                        <input type="text" name="name_uz" id="name_uz" value="{{ old('name_uz', $category->name_uz) }}" class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:border-indigo-500 focus:ring-indigo-500 shadow-sm">
                        @error('name_uz')
                ...
                <div id="fields-ru" class="lang-fields hidden">
                    <div>
                        ...
                        <input type="text" name="name_ru" id="name_ru" value="{{ old('name_ru', $category->name_ru) }}" class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:border-indigo-500 focus:ring-indigo-500 shadow-sm">
                        @error('name_ru')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div id="fields-en" class="lang-fields hidden">
                    <div>
                        ...
                        <input type="text" name="name_en" id="name_en" value="{{ old('name_en', $category->name_en) }}" class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:border-indigo-500 focus:ring-indigo-500 shadow-sm">
                        @error('name_en')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
