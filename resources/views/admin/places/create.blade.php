                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="flex gap-2">
                            <input type="text" name="latitude" id="latitude" value="{{ old('latitude') }}" placeholder="Latitude" class="flex-1 rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:border-indigo-500 focus:ring-indigo-500 shadow-sm" readonly>
                            <input type="text" name="longitude" id="longitude" value="{{ old('longitude') }}" placeholder="Longitude" class="flex-1 rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:border-indigo-500 focus:ring-indigo-500 shadow-sm" readonly>
            ...
            if (categorySelect.value) {
                ...
                if (oldSubcategoryId) {
                    setTimeout(() => {
                        ...
                        loadBrands(oldSubcategoryId);
                        
                        // Set the old brand value if it exists
                        if (oldBrandId) {
                            setTimeout(() => {
                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-lg font-semibold text-gray-900 dark:text-white">
                                <span id="modal-latitude">{{ old('latitude', '41.2995') }}</span>, 
                                <span id="modal-longitude">{{ old('longitude', '69.2401') }}</span>
                            </p>
                        </div>
                    </div>
