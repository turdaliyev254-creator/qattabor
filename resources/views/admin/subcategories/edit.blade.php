            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <div class="flex gap-3">
                        <input type="text" name="icon" id="icon" value="{{ old('icon', $subcategory->icon) }}" class="flex-1 rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:border-indigo-500 focus:ring-indigo-500 shadow-sm" readonly>
                    ...
                    <div id="iconPreview" class="mt-2 {{ old('icon', $subcategory->icon) ? '' : 'hidden' }}">
                        <img id="iconPreviewImage" src="{{ old('icon', $subcategory->icon) ? '/size-512/images/' . old('icon', $subcategory->icon) : '' }}" alt="Selected icon" class="w-16 h-16 object-contain border border-gray-300 rounded-lg p-2">
                    </div>
