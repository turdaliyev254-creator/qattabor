    ...
    <form method="POST" action="{{ route('register') }}" class="space-y-5" id="registerForm">
        ...
        <div>
            ...
            <div class="relative">
                ...
                <x-text-input id="name" class="block w-full pl-10 pr-4 py-3 text-sm rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 focus:border-blue-500 dark:focus:border-blue-400 focus:ring-2 focus:ring-blue-500/20 text-gray-900 dark:text-white placeholder-gray-400 transition-all duration-200"
                            type="text"
                            name="name"
                            :value="old('name')"
        ...
        <div>
            ...
            <p class="text-xs text-red-600 dark:text-red-400 mt-1.5 hidden" id="passwordError"></p>
        </div>
        ...
        <div class="flex flex-col gap-4 mt-8">
            ...
            <a href="{{ route('login') }}" class="w-full text-center bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300 font-semibold py-3.5 px-6 rounded-xl border-2 border-gray-300 dark:border-gray-600 hover:border-blue-500 dark:hover:border-blue-400 hover:text-blue-600 dark:hover:text-blue-400 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
                {{ __('Sign In') }}
            </a>
        </div>
    </form>
    ...
    <script>
        ...
        function validatePhone() {
            ...
            if (value && !phoneRegex.test(value)) {
                phoneError.textContent = '{{ __("Phone must be in format: +998XXXXXXXXX") }}';
